...
//         <div className="mx-auto px-24 md:px-26 bg-white/70 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.12)] border border-white/40 transition-all duration-300">
...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <nav className="fixed left-0 right-0 z-50">
        <div
          className={`mx-auto px-24 md:px-26 backdrop-blur-xl transition-all duration-300
          ${
            scrolled

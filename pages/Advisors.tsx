    ...
    <div className="pt-24 md:pt-32 bg-zinc-50 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-zinc-300 text-sm font-medium">
                    Exclusive portal access for authorized financial advisors
                    and brokers.
                  </p>
                </div>
              </motion.div>
              ...
              <Link
                to="/contact"
                className="px-8 py-4 bg-white text-brand-navy rounded-full font-bold hover:bg-brand-cyan hover:text-white transition-all shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(0,144,212,0.4)] flex items-center gap-2 group transform hover:-translate-y-1 inline-flex"
              >
                Request Access{" "}
      ...
      <Section className="relative z-0 -mt-20 pt-32 pb-24">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-brand-navy mb-12">
            Our Specialization
          </h2>

          {/* Added mt-6 padding-top to card to prevent text overlap with top border */}
          <SpotlightCard
            className="bg-white border border-zinc-200 rounded-[2.5rem] shadow-xl relative overflow-hidden text-left"
            ...
            <div className="relative z-10 p-6 md:p-14 pt-10 md:pt-16 grid md:grid-cols-[1fr_auto] gap-10 items-center">
              <div className="space-y-8">
                ...
                <p className="text-lg text-zinc-600 leading-relaxed font-light">
                  ...
                  most with our simple transfer of access form.
                </p>
              </div>
      ...
      <Section className="bg-zinc-50 text-brand-navy relative overflow-hidden py-24 border-b border-zinc-200">
        <div className="max-w-6xl mx-auto relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="font-display text-4xl md:text-5xl font-bold mb-8 tracking-tight text-brand-navy">
            ...
            <div className="bg-white p-8 rounded-3xl border border-zinc-200 mb-8 shadow-lg relative overflow-hidden group hover:border-red-200 transition-colors">
              ...
              <p className="text-zinc-800 mb-4 font-medium text-2xl leading-relaxed">
                Cyber-enabled attacks targeting adults aged 60+ are up over{" "}
                <span className="text-red-500 font-bold">40%</span> as of 2026.
              </p>

              <p className="text-zinc-500 italic text-base pl-4 text-sm space-y-2">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="bg-zinc-100 border border-zinc-200 p-8 rounded-3xl hover:bg-zinc-200 transition-colors duration-300">
              <h4 className="font-bold text-zinc-500 text-xs uppercase tracking-widest mb-6 border-b border-zinc-300 pb-2">
                Old Targets
              </h4>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="relative h-full">
              <SpotlightCard
                className="bg-brand-navy text-white p-6 md:p-10 rounded-[2.5rem] border border-brand-dark shadow-2xl relative overflow-hidden h-full flex flex-col justify-center"
              ...
              >
                ...
                <div className="space-y-6 relative z-10 text-zinc-300">
                  <p className="leading-relaxed text-lg">
                    ...
                    shared so all documents can be easily accessed anywhere in
                    the world. If desired, multiple computer copies can be made
                    to allow more than one party to access accounts and personal
                    information.
                  </p>
      ...
      <Section className="bg-zinc-50 relative border-t border-zinc-200 pb-32">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold text-brand-navy mb-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <SpotlightCard className="bg-white p-6 md:p-10 rounded-[2rem] border border-zinc-200 shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col h-full group">
              ...
              <p className="text-zinc-600 mb-8 flex-grow text-lg leading-relaxed">
                Paid for by Broker/Client for security updates, encryption, EDR,
                administration and access to assist clients.
              </p>
              <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-100 text-sm font-semibold text-brand-navy flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5 text-brand-cyan" /> Full
            ...
            <SpotlightCard className="bg-white p-6 md:p-10 rounded-[2rem] border border-zinc-200 shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col h-full group">
              ...
              <p className="text-zinc-600 mb-8 flex-grow text-lg leading-relaxed">
                For the broker if they wish to customize laptops to have their
                logo on every client computer. This includes up to 2 hrs. of
              ...
              <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-100 text-sm font-semibold text-zinc-500 flex items-center gap-2">
                <AlertTriangle className="w-4 h-4" /> Beyond that tech support
                is $150 hr.
              </div>
            </SpotlightCard>
          </div>
            ...
            >
              ...
              <ul className="space-y-4 text-sm text-zinc-600 font-medium">
                ...
                <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-zinc-50 transition-colors">
                  <div className="w-1.5 h-1.5 rounded-full bg-zinc-300 mt-2"></div>
                  <span>
                    <span className="font-bold text-brand-navy">$100</span> to
                    reprogram computer
                  </span>
                </li>
                <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-zinc-50 transition-colors">
            ...
            >
              ...
              <ul className="space-y-4 text-sm text-zinc-600 font-medium">
                ...
                <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-zinc-50 transition-colors">
                  <div className="w-1.5 h-1.5 rounded-full bg-zinc-300 mt-2"></div>
                  <span>
                    <span className="font-bold text-brand-navy">$200</span> per
                    year for all EDR ongoing updates and support
                  </span>
                </li>
                <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-zinc-50 transition-colors">
                  <div className="w-1.5 h-1.5 rounded-full bg-zinc-300 mt-2"></div>

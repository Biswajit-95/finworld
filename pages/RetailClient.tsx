...
import { ShieldCheck, Lock, Globe, Server, UserCheck, AlertTriangle, Wifi, Cloud, Share2, Briefcase, User, Monitor, Key, ArrowRight, HeartHandshake, FileCheck } from 'lucide-react';
    ...
    <div className="pt-24 md:pt-32 bg-zinc-50">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <h1 className="font-display text-5xl md:text-7xl font-bold text-white mb-6 leading-[1.1] tracking-tight">
                        Retail Client <br/>
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-cyan to-white opacity-90">Secure Vault</span>
                    </h1>
                        ...
                        />
                         ...
                         <div className="absolute bottom-8 left-8 right-8">
                             <div className="flex items-center gap-4 mb-4">
                                 ...
                                 <div>
                                     <div className="text-white font-bold text-lg">Vault Locked</div>
                                     <div className="text-zinc-400 text-xs uppercase tracking-wider">AES-256 Encrypted</div>
                                 </div>
                             </div>
                         </div>
                    </div>
          ...
          <div className="max-w-5xl mx-auto text-center">
              <div className="bg-white border border-zinc-100 shadow-xl shadow-zinc-200/50 p-8 md:p-12 rounded-[2.5rem] relative overflow-hidden group">
                  ...
                  <h2 className="text-2xl md:text-4xl text-brand-navy font-serif font-medium leading-relaxed">
                      "This is a <span className="text-brand-cyan font-bold">digital vault</span> combined with a secured device to safeguard private information. It is an easy way to transfer all your important data to your heirs when they will need it most."
                  </h2>
      ...
      <Section className="bg-zinc-950 text-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
            <div className="text-center mb-16">
                <h2 className="font-display text-4xl md:text-5xl font-bold mb-6">Why the Need for FinWorld?</h2>
                <p className="text-zinc-400 text-xl max-w-2xl mx-auto">Over 30 years of financial planning seeing the same problem happening over and over.</p>
            </div>
            
            <div className="grid md:grid-cols-2 gap-6">
                {[
                    { text: "Spouses struggling to take over and manage the family's affairs after the death of a partner.", icon: HeartHandshake },
                    { text: "Children struggling to find everything needed to manage and settle an estate.", icon: User },
                    { text: "Out of state executors with limited time to find everything needed to manage and settle the estate.", icon: Globe },
                    { text: "Secure way to store sensitive documents and conduct financial business electronically.", icon: FileCheck }
                ].map((item, i) => (
                    <div key={i} className="flex gap-6 p-6 md:p-8 rounded-3xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-brand-cyan/30 transition-all duration-300 group">
                        ...
                        <div>
                            <p className="text-zinc-200 text-lg leading-relaxed font-light">{item.text}</p>
                        </div>
                    </div>
                ))}
            </div>
      ...
      <Section className="bg-zinc-50 border-b border-zinc-200">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div>
                  ...
                  <div className="bg-white p-6 md:p-8 rounded-3xl border border-zinc-200 shadow-sm mb-8 hover:shadow-md transition-shadow">
                      ...
                      <div className="p-5 bg-red-50 rounded-2xl border border-red-100 flex items-start gap-4">
                          ...
                          <div>
                              <h4 className="font-bold text-red-900 text-sm uppercase tracking-wide mb-1">Remote Wipe Protocol</h4>
              ...
              <div>
                  <h2 className="font-display text-3xl font-bold text-brand-navy mb-6">FinWorld also leverages:</h2>
                  <ul className="space-y-4">
                      <li className="bg-white p-6 rounded-2xl border border-zinc-200 flex items-center gap-5 hover:border-brand-cyan hover:shadow-lg transition-all group">
                          ...
                          <span className="font-bold text-zinc-700 text-lg">Encryption (AES or TLS 1.2(3) and SSL technology).</span>
                      </li>
                      <li className="bg-white p-6 rounded-2xl border border-zinc-200 flex items-center gap-5 hover:border-brand-cyan hover:shadow-lg transition-all group">
                           <div className="w-12 h-12 bg-brand-navy rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform">
                              <Wifi className="w-6 h-6" />
                          </div>
                          <span className="font-bold text-zinc-700 text-lg">VPN services incorporate End-to-End Encryption.</span>
                      </li>
                      <li className="bg-white p-6 rounded-2xl border border-zinc-200 flex items-center gap-5 hover:border-brand-cyan hover:shadow-lg transition-all group">
                           <div className="w-12 h-12 bg-brand-navy rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform">
                              <Cloud className="w-6 h-6" />
                          </div>
                          <span className="font-bold text-zinc-700 text-lg">Cloud Encryption is on the horizon.</span>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <Section className="bg-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
                ...
                <SpotlightCard key={i} className="bg-zinc-50 p-6 md:p-8 rounded-3xl border border-zinc-200 hover:border-brand-cyan hover:shadow-xl hover:shadow-brand-cyan/10 transition-all duration-300 h-full flex flex-col" spotlightColor="rgba(0, 144, 212, 0.08)">
      ...
      <Section className="bg-zinc-50 border-y border-zinc-200">
        <div className="text-center mb-16">
            <h2 className="font-display text-3xl font-bold text-brand-navy">Different Types of FinWorld Intranets</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-[2rem] shadow-lg border border-zinc-100 hover:border-brand-navy transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-zinc-600 text-sm leading-relaxed">A private, online, internal communications network accessible only to FinWorld broker dealers, brokers and their clients.</p>
            </div>
            <div className="bg-white p-8 rounded-[2rem] shadow-lg border border-zinc-100 hover:border-brand-cyan transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-zinc-600 text-sm leading-relaxed">A closed private network only accessible to select external parties that FinWorld validates are safe and linked for direct communication.</p>
            </div>
            <div className="bg-white p-8 rounded-[2rem] shadow-lg border border-zinc-100 hover:border-zinc-900 transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-zinc-600 text-sm leading-relaxed mb-4">A gateway with a public-facing web page that allows the intranet/extranet to connect with broker dealers, brokers and their clients.</p>
      ...
      <Section className="bg-zinc-900 text-white relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
             <div>
                 <h2 className="font-display text-4xl font-bold mb-6">Why Is This Important?</h2>
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                     <div className="bg-white/5 p-6 rounded-2xl border border-white/5 hover:bg-white/10 transition-colors">
                         <h4 className="font-bold text-zinc-500 uppercase tracking-widest text-xs mb-4">Old Targets</h4>
                         <ul className="space-y-3 text-zinc-400 text-sm">
                             <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-zinc-600"></span> Hospitals</li>
                             <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-zinc-600"></span> Oil companies</li>
                             <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-zinc-600"></span> Big companies</li>
                             <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-zinc-600"></span> Ransomware for crypto</li>
                         </ul>
                     </div>
                     <div className="bg-red-950/20 p-6 rounded-2xl border border-red-900/30 hover:border-red-500/50 transition-colors shadow-[0_0_30px_rgba(239,68,68,0.1)]">
                         ...
                         <ul className="space-y-3 text-white font-bold text-sm">
                             <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse"></span> Mom and Dad</li>
                             <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse"></span> Grandma and Grandpa</li>
                             <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse"></span> Great Grandma</li>
                             <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse"></span> Non-tech savvy users</li>
                         </ul>
                     </div>
                 </div>
             </div>
             ...
             <div className="flex flex-col gap-8">
                 <div className="relative h-48 rounded-2xl overflow-hidden border border-zinc-700 opacity-60 hover:opacity-100 transition-opacity">
                      <div className="absolute top-4 right-4 bg-black/80 text-white text-[10px] px-3 py-1 rounded-full uppercase font-bold z-10">Old Target</div>
                      <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=600" className="w-full h-full object-cover grayscale" alt="Corporate" />
                 </div>
                 <div className="relative h-64 rounded-2xl overflow-hidden border-2 border-red-500 shadow-2xl shadow-red-900/20 hover:scale-[1.02] transition-transform duration-500">
                      <div className="absolute top-4 right-4 bg-red-600 text-white text-[10px] px-3 py-1 rounded-full uppercase font-bold z-10 shadow-lg animate-pulse">New Target</div>
                      <img src="/new-targets.png"  className="w-full h-full object-cover" alt="Elderly Couple" />
                      <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                          <p className="text-white text-xs font-bold text-center">Protected by FinWorld</p>
                      </div>
                 </div>
             </div>
        </div>
      ...
      <Section className="bg-white">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative rounded-[2rem] bg-zinc-900 p-4 shadow-2xl border border-zinc-200">
                        ...
                        <div className="rounded-2xl overflow-hidden border border-zinc-700 relative bg-zinc-800 aspect-[16/10]">
                            ...
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-xl text-center">
                                ...
                                <p className="text-white font-bold text-sm">Secure Portal Active</p>
                            </div>
                        </div>
               ...
               <div className="order-1 lg:order-2">
                   <h2 className="font-display text-4xl font-bold text-brand-navy mb-6">What Does FinWorld Look Like?</h2>
                   ...
                   <div className="mb-8">
                       <h4 className="font-bold text-brand-navy mb-4 flex items-center gap-2">
                           <Monitor className="w-5 h-5 text-brand-cyan" /> No one-size-fits-all intranet solution:
                       </h4>
                   ...
                   <div className="space-y-4">
                       <div className="p-6 bg-white border border-zinc-200 rounded-2xl shadow-sm hover:border-brand-navy hover:shadow-lg transition-all group">
                           <div className="flex items-center gap-3 mb-2">
                               ...
                               <h4 className="font-bold text-brand-navy text-lg group-hover:text-brand-cyan transition-colors">Brokers</h4>
                           </div>
                       ...
                       <div className="p-6 bg-brand-navy border border-brand-navy rounded-2xl shadow-lg text-white group">
                           <div className="flex items-center gap-3 mb-2">
                               ...
                               <h4 className="font-bold text-white text-lg group-hover:text-brand-cyan transition-colors">Broker Dealers</h4>
                           </div>
      ...
      <Section className="bg-zinc-50 border-t border-zinc-200 relative overflow-hidden">
          <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                  <span className="text-brand-cyan font-bold uppercase tracking-widest text-xs mb-2 block">Legacy Protection</span>
                  <h2 className="font-display text-4xl md:text-5xl font-bold text-brand-navy mb-4">Transfer of Access</h2>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
                  ...
                  <div>
                      ...
                      <div className="space-y-8 relative">
                          {/* Vertical Line */}
                          <div className="absolute left-6 top-4 bottom-4 w-0.5 bg-zinc-200"></div>

                          {/* Steps */}
                          <div className="relative flex gap-6 items-start">
                              <div className="w-12 h-12 rounded-full bg-white border-4 border-zinc-100 text-brand-navy font-bold flex items-center justify-center relative z-10 shadow-sm">1</div>
                              <div className="pt-2">
                                  <h4 className="text-lg font-bold text-brand-navy">Secure Organization</h4>
                                  <p className="text-zinc-600 text-sm">You organize your assets and documents within the FinWorld Vault today.</p>
                              </div>
                          </div>
                          <div className="relative flex gap-6 items-start">
                              <div className="w-12 h-12 rounded-full bg-white border-4 border-zinc-100 text-brand-navy font-bold flex items-center justify-center relative z-10 shadow-sm">2</div>
                              <div className="pt-2">
                                  <h4 className="text-lg font-bold text-brand-navy">Time of Need</h4>
                                  <p className="text-zinc-600 text-sm">When incapacitation or death occurs, the protocol is triggered.</p>
                              </div>
                          </div>
                          <div className="relative flex gap-6 items-start">
                              <div className="w-12 h-12 rounded-full bg-brand-cyan text-white font-bold flex items-center justify-center relative z-10 shadow-lg shadow-brand-cyan/20">3</div>
                              <div className="pt-2">
                                  <h4 className="text-lg font-bold text-brand-navy">Secure Handoff</h4>
                                  <p className="text-zinc-600 text-sm">Passwords and login info are shared securely. Multiple keys can be issued for shared access.</p>
                              </div>
                          </div>
                          <div className="relative flex gap-6 items-start">
                              <div className="w-12 h-12 rounded-full bg-brand-navy text-white font-bold flex items-center justify-center relative z-10 shadow-lg shadow-brand-navy/20">4</div>
                              <div className="pt-2">
                                  <h4 className="text-lg font-bold text-brand-navy">Continuity</h4>
                                  <p className="text-zinc-600 text-sm">Documents accessed anywhere in the world. Trustees pick up exactly where you left off.</p>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-zinc-100">
                      <h3 className="text-xl font-bold text-brand-navy mb-8 text-center">Authorized Beneficiaries</h3>
                      <div className="grid grid-cols-2 gap-4">
                        {[
                            ...
                            <div key={i} className="flex flex-col items-center justify-center p-6 rounded-2xl bg-zinc-50 border border-zinc-100 hover:border-brand-cyan hover:bg-brand-cyan/5 transition-all duration-300 group">
                                <item.icon className="w-8 h-8 text-zinc-400 mb-3 group-hover:text-brand-cyan transition-colors" />
                                <span className="font-bold text-brand-navy text-sm text-center">{item.role}</span>
                            </div>
                        ))}
                      </div>
                  </div>
              ...
              <div className="bg-brand-navy rounded-[3rem] p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
                  ...
                  <div className="relative z-10 max-w-3xl mx-auto">
                      <h3 className="font-serif text-3xl md:text-5xl font-bold text-white mb-8 leading-tight">
                          "The gift of organization is the ultimate final gift one can receive."
                      </h3>
                      <div className="flex flex-col sm:flex-row justify-center gap-4">
                          <Link to="/contact" className="px-8 py-4 bg-white text-brand-navy font-bold rounded-full hover:bg-brand-cyan hover:text-white transition-all shadow-lg flex items-center justify-center gap-2">

    ...
    <div className="flex flex-col min-h-screen bg-zinc-50">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full flex-grow flex flex-col justify-start lg:justify-center mt-[33vh] md:mt-[38vh] lg:mt-0">
          <div className="grid lg:grid-cols-2 gap-12 items-center h-full">
            ...
            >
              ...
              <p className="hidden md:block text-zinc-500 mb-10 max-w-lg leading-relaxed text-sm border-l-2 border-brand-cyan pl-4">
                FinWorld’s purpose is to enhance and simplify the use of
                technology in the collection of personal data in a safe, simple
                and secure manner.
              </p>
      ...
      <div className="border-y border-brand-navy/10 bg-white overflow-hidden py-5 relative z-20 shadow-sm">
        <div className="flex gap-20 animate-marquee whitespace-nowrap">
          {[...Array(8)].map((_, i) => (
            <div
              key={i}
              className="flex items-center gap-3 text-sm font-mono text-brand-navy font-bold tracking-tight uppercase opacity-80 hover:opacity-100 transition-opacity"
            >
              <Activity className="w-4 h-4 text-brand-cyan" />{" "}
              AES-256_ENCRYPTION_ACTIVE
              <span className="mx-2 text-zinc-300">///</span>
              <Lock className="w-4 h-4 text-brand-navy" />{" "}
              ISOLATION_PROTOCOL_READY
            </div>
          ))}
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
            <div>
              ...
              <h2 className="font-display text-4xl md:text-5xl font-bold mb-8 tracking-tighter text-white">
                Why Is This <br />
                <span className="text-zinc-500">Important?</span>
              </h2>
              <div className="mb-10 p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
                <p className="text-white mb-4 font-light text-2xl leading-relaxed">
                  ...
                  <span className="text-red-500 font-bold">40%</span> as of
                  2026.
                </p>

                <p className="text-zinc-400 font-medium italic border-l-2 border-red-500 pl-4 text-sm space-y-2">
                  <span className="block">
                    Reported cyber-enabled losses for Americans age 60+
                    increased about five-fold from 2020 to 2024 (from ~$966M to
                    ~$4.8B).
                  </span>
                  <span className="block">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="p-6 rounded-2xl bg-red-950/20 border border-red-900/30 relative overflow-hidden group hover:bg-red-950/30 hover:border-red-500/50 transition-all duration-300 hover:scale-105 shadow-lg">
                  ...
                  <div className="flex items-center gap-2 mb-4 relative z-10">
                    ...
                    <h3 className="text-red-500 font-bold uppercase tracking-widest text-xs">
                      Current Targets
                    </h3>
                  </div>
            ...
            <div className="relative h-full flex items-center">
              <div className="relative h-[300px] md:h-[400px] w-full bg-zinc-950 rounded-3xl border border-white/10 shadow-2xl overflow-hidden flex flex-col ring-1 ring-white/10 mt-8 md:mt-0 shadow-black group hover:shadow-brand-cyan/20 transition-all duration-500">
                ...
                <div className="absolute top-4 right-4 z-10">
                  <span className="text-xs font-mono text-zinc-500 group-hover:text-brand-cyan transition-colors">
                    LIVE_THREAT_MONITOR
                  </span>
                </div>
                ...
                <div className="flex-grow relative">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 flex justify-between bg-zinc-900/80 backdrop-blur-sm p-4 rounded-xl border border-white/5">
                    <div>
                      ...
                      <span className="block text-emerald-500 font-bold font-mono text-lg">
                        SECURE
                      </span>
                    </div>
                    <div className="text-right">
                      ...
                      <span className="block text-white font-bold font-mono text-lg">
                        99.9%
                      </span>
                    </div>
                  </div>
      ...
      <Section className="bg-white">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <SpotlightCard className="bg-white border border-zinc-200 shadow-xl p-6 md:p-8 flex flex-col h-full hover:border-brand-cyan transition-all duration-300 hover:-translate-y-2 group">
            ...
            <h3 className="text-2xl font-bold text-brand-navy mb-4 group-hover:text-brand-cyan transition-colors">
              INTRANET
            </h3>
            <p className="text-zinc-600 leading-relaxed text-sm flex-grow">
              A private, online, internal communications network accessible{" "}
              <strong>only</strong> to FinWorld broker dealers, brokers and
              their clients.
            </p>
          </SpotlightCard>
          ...
          <SpotlightCard className="bg-white border border-zinc-200 shadow-xl p-6 md:p-8 flex flex-col h-full hover:border-brand-cyan transition-all duration-300 hover:-translate-y-2 group">
            ...
            <p className="text-zinc-600 leading-relaxed text-sm flex-grow">
              ...
              communication and collaboration for the broker, broker dealer and
              end user.
            </p>
          </SpotlightCard>
      ...
      <Section className="bg-zinc-50 border-y border-zinc-200">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="group">
            ...
            <h2 className="text-3xl font-bold text-brand-navy mb-6 group-hover:text-brand-cyan transition-colors">
              The Secure Device & Vault
            </h2>
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm group-hover:shadow-lg transition-all duration-500 group-hover:border-brand-cyan/30">
                <p className="font-medium text-lg leading-relaxed text-zinc-700">
                  FinWorld provides a secure device accessible solely through
                  our intranet portal to view and manage important personal
                  wealth, assets and essential documents.
                </p>
              </div>
              <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm group-hover:shadow-lg transition-all duration-500 group-hover:border-brand-cyan/30 delay-100">
                <p className="leading-relaxed text-zinc-600">
                  This is a digital vault combined with a secured device to
                  safeguard private information and is an easy way to transfer
                  all your important data to your heirs when they will need it
                  most with our simple <strong>transfer of access form</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="group">
            ...
            <div className="space-y-6">
              <div className="flex gap-4 p-5 rounded-2xl bg-white border border-zinc-200 hover:border-brand-navy hover:bg-brand-navy hover:text-white hover:shadow-xl transition-all duration-300 group/item cursor-default shadow-sm">
                ...
                <div>
                  <h4 className="font-bold text-brand-navy mb-2 text-lg group-hover/item:text-white transition-colors">
                    Restricted Access
                  </h4>
                  <p className="text-zinc-600 text-sm leading-relaxed group-hover/item:text-zinc-200 transition-colors">
                    We restrict access to sensitive information using a series
                    of integrated role-based files and page permissions on a
                    regular basis. Information can only be accessed by IP
                    address, device, username and password.
                  </p>
                </div>
              </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={i}
                className="flex items-start gap-5 bg-zinc-900/80 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-white/5 hover:border-brand-cyan/50 hover:bg-zinc-800 hover:shadow-2xl hover:shadow-brand-cyan/10 hover:-translate-y-1 transition-all duration-300 group"
              >
                ...
                <p className="text-zinc-300 font-medium leading-relaxed text-lg group-hover:text-white transition-colors">
                  {item.text}
                </p>
              </div>
            ))}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1">
              ...
              <div className="space-y-6 text-lg text-zinc-600">
                <p className="leading-relaxed">
                  At time of need, passwords and login information will be
                  shared so all documents can be easily accessed anywhere in the
                  world. If desired, multiple computer copies can be made to
                  allow more than one party to access accounts and personal
                  information.
                </p>
                <div className="bg-brand-navy/5 p-8 rounded-2xl border-l-4 border-brand-cyan mt-8">
                  <p className="font-bold text-brand-navy italic text-xl">
                    "This allows trustees, children and other responsible
                    parties to pick up right where you left off. The gift of
                    organization is the ultimate final gift one can receive."
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 md:order-2 grid gap-5">
              {[
                ...
                <div
                  key={idx}
                  className="group bg-white p-6 rounded-2xl border border-zinc-200 flex items-center gap-5 shadow-md hover:shadow-xl hover:shadow-brand-cyan/10 hover:border-brand-cyan hover:bg-zinc-50 transition-all duration-300 transform hover:-translate-y-1 cursor-default"
                >
      ...
      <section className="py-24 md:py-32 px-4 bg-zinc-900 text-center relative overflow-hidden border-t border-zinc-800">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <h2 className="font-display text-4xl md:text-7xl font-bold text-white mb-8 tracking-tighter">
            Secure Your Legacy.
          </h2>
          <p className="text-lg md:text-xl text-zinc-400 mb-10 font-light">
            Organization is the ultimate final gift.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="px-12 py-5 bg-white text-brand-navy font-bold rounded-full hover:scale-105 transition-transform shadow-lg shadow-white/10 hover:bg-zinc-100 flex items-center justify-center gap-2 group"
            >
              Get Started{" "}
            ...
            <Link
              to="/pricing"
              className="px-12 py-5 bg-transparent border border-brand-cyan text-white font-bold rounded-full hover:bg-brand-cyan hover:border-brand-cyan transition-colors"
            >
              View Pricing
            </Link>
          </div>

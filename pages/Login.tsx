        ...
        <div className="hidden lg:flex lg:w-1/2 relative bg-brand-navy overflow-hidden flex-col justify-between p-16 text-white">
           ...
           <div className="relative z-10 max-w-lg">
               ...
               <p className="text-zinc-300 text-lg leading-relaxed font-light">
                   Access your isolated financial environment securely. All connections are encrypted with military-grade AES-256 protocols.
               </p>
           </div>
          ...
          <div className="mx-auto w-full max-w-md">
              ...
              <div className="space-y-5">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2 ml-1">
                        <label htmlFor="password" className="block text-sm font-bold text-brand-navy">
                          Password
                        </label>
                        <Link to="/forgot-password" className="text-xs font-bold text-brand-cyan hover:text-brand-navy transition-colors">
                          Forgot password?
                        </Link>
                    </div>
                    <div className="relative">
            ...
            <div className="mt-8 text-center border-t border-zinc-100 pt-8">
               <p className="text-zinc-500 text-sm">
                 ...
                 <Link to="/signup" className="font-bold text-brand-cyan hover:text-brand-navy transition-colors">
                   Sign up
                 </Link>
               </p>
            </div>
